...
internal fun PathVariableEditor(
  ...
  Column(
    ...
    Text(
      text = stringResource(id = R.string.pathfinder_edit_path_variables_dialog_title),
      style = MaterialTheme.typography.h6
    )
    Spacer(modifier = Modifier.height(24.dp))
    props.variables.forEachIndexed { index, variable ->
      Spacer(modifier = Modifier.height(16.dp))
      Variable(item = variable, onValueChange = { onValueChange(index, it) })
    }
    Spacer(modifier = Modifier.height(24.dp))
...
private fun Variable(
  item: PathVariableEditorProps.Variable,
